...
//       <div ref={dragRef} className='drag-and-drop' onDragEnter={onDragEnter} onDragLeave={onDragLeave}>
//         <div className="drag-input">
//           <p>Drag and Drop Image Here</p>
//           <Image alt="Upload Logo" src={uploadLogo} className='upload-logo' />
//         </div>
//         <input type="file" value='image' name='image' accept="image/*" onChange={upload} onClick={disableClick} />
//       </div>
//       <label htmlFor="image">
//         <input type="file" id='image' name="image" accept="image/*" onChange={upload} />
//         Choose Image
//       </label>
//     </div>
//   )
